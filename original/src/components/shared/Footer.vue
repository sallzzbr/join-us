<template>
    <b-container fluid>
        <b-row class="custom-footer">
            <b-col cols="12" sm="2" class="ml-sm-5 mt-3">
                <b-row>
                    <b-col cols="4" sm="3" offset-sm="1">
        ...
        <b-row class="mt-3">
            <b-col cols="12">
                <b-row>
                    ...
                    <b-col cols="12" sm="2" class="mt-5 mt-sm-0"> 
                        <h4>Institucional</h4> 
                        <ul> 
                    ...
                    <b-col cols="12" sm="3" class="newsletter d-none d-sm-block"> 
                ...
                <b-row class="footer-bottom mt-3 text-left"> 
                    <b-col cols="12" sm="5" offset-sm="1" class="mt-2">
                        <p>
                    ...
                    <b-col sm="2" class="mb-3 my-sm-auto" offset="3" offset-sm="4"> 
                        <img src="../../assets/logo.svg" alt="original.io logo" class="bottom-logo">
                    </b-col> 
                </b-row>
            </b-col> 
        </b-row>
